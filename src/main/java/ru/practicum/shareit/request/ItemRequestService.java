...
public interface ItemRequestService {
    ItemRequestDto addNewItemRequest(Long requesterId, ItemRequestDto itemRequestDto) throws IncorrectObjectException, IncorrectFieldException;

    List<ItemRequestForGetDto> getAllItemRequestsByRequesterId(Long requesterId) throws IncorrectObjectException;

    List<ItemRequestForGetDto> getAllItemRequests(Long requesterId) throws IncorrectObjectException;

    List<ItemRequestForGetDto> getAllItemRequestsByPages(Long requesterId, Integer from, Integer size) throws IncorrectObjectException;
